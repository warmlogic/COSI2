...
# list length
test_numTargets_Left = 5
test_numTargets_Right = 5
...
prac_numLists = 2
pracstudy_listLen = 4
pracstudy_bufferStart = 1
pracstudy_bufferEnd = 1
practest_numLures = 2
...
minImpedanceTime = 240000 # 240000ms=4min
...
# BEHAVIORAL ONLY: amount of time to break between study and test (for
# when isEEG == False)
...
study_sourcePreview = 500
study_stimDuration = 2000
